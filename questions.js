const questions = [
  ...
  },
  {
   ...
   {
  question: "หากต้องการวางแผนเกษียณให้มั่นคงที่สุด ข้อใดสำคัญที่สุด?",
  answers: [
    "การใช้บัตรเครดิตเพื่อสะสมแต้ม",
    "การออมเงินระยะสั้น",
    "การลงทุนแบบกระจายความเสี่ยงและต่อเนื่อง",
    "การซื้อของแบรนด์เนมเก็บไว้"
  ],
  correct: 2,
  explanation: "การวางแผนเกษียณที่มั่นคง ควรออมระยะยาวและกระจายการลงทุนต่อเนื่องเพื่อลดความเสี่ยงและสร้างผลตอบแทน"
}
