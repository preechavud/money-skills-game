...
const events = [
  ...
  { text: "แก๊งค์คอลฯ หลอกโอน -5,000", cost: 5000 },
  ...
  { text: "ลืมจ่ายบิลค่าไฟ -2,000", cost: 2000 },
   { text: "เจอเงินในซอกโซฟา +200", cost: -200 },
  { text: "โดนปรับค่าที่จอดรถ -1,000", cost: 1000 },
  { text: "ได้รับของแถมจากร้านกาแฟ +300", cost: -300 },
  { text: "นายจ้างหักเงินเดือน! -9,000", cost: 9000 },
  { text: "ไม่มีเหตุการณ์พิเศษ", cost: 0 }
  { text: "เก็บเหรียญหล่นในลิฟต์ +50", cost: -50 },
  { text: "ทำแผลโดนแมวเพื่อนข่วน -1,500", cost: 1500 },
    { text: "ได้รางวัลกิจกรรมในออฟฟิศ +700", cost: -700 },
  { text: "ซื้อต้นไม้ แล้วก็ตายไปแล้ว -600", cost: 600 },
    { text: "เพื่อนคืนเงินยืมมาแบบไม่คาดฝัน +1,000", cost: -1000 },
  { text: "ทำบุญงานศพป้าข้างบ้าน -2,000", cost: 2000 },
  { text: "กระเป๋าเงินตกส้วม -800", cost: 800 },
  { text: "ลืมจ่ายค่าลิขสิทธิ์เพลงในงานเลี้ยง -4,000", cost: 4000 },
    { text: "เจอเงินในกระเป๋ากางเกงเก่า +150", cost: -150 },
  { text: "โอนเงินผิดบัญชี -3,500", cost: 3500 },
  { text: "จ่ายค่าปรับจอดจักรยานผิดที่ -500", cost: 500 },
  { text: "โดนหวยใต้ดินกิน -200", cost: 200 },
    { text: "ถูกรางวัลจากบัตรขูด +300", cost: -300 },
  { text: "เครื่องดูดฝุ่นในออฟฟิศพังคามือ -2,500", cost: 2500 },
  { text: "ทิปเด็กส่งพิซซ่า -50", cost: 100 },
];
